...
{
	if(!IsPlayerInRangeOfPoint(playerid, 3.5, 1186.41, -891.32, 43.30)) return Error(playerid, "Kamu harus di dapur!");
	...
	format(Dstring, sizeof(Dstring), "{ffffff}%sFried Chiken(5)\tPotato 2 + snack 2\n", Dstring);
	format(Dstring, sizeof(Dstring), "{ffffff}%sBurger(5)\tOrange 3 + Potato 3\n", Dstring);
...
{
    if(IsPlayerInRangeOfPoint(playerid,2.0, 1198.13, -889.93, 43.16))
    {
