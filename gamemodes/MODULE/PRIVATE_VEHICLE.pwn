...
{		
	...
	{
		new vehid;
		if(!IsPlayerInRangeOfPoint(playerid, 3.0, 1321.33, -885.54, 39.66) && !IsPlayerInRangeOfPoint(playerid, 3.0, 1689.7552, -2311.7261, 13.5469) && !IsPlayerInRangeOfPoint(playerid, 3.0, 804.9299, -1362.8210, 13.5469) && !IsPlayerInRangeOfPoint(playerid, 3.0, 1757.7032, -1864.0552, 13.5743)) return Error(playerid, "You must in showroom/dealer!");
