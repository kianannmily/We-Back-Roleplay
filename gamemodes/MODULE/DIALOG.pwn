...
public OnDialogResponse(playerid, dialogid, response, listitem, inputtext[])
{
    ...
    if(dialogid == DIALOG_LOGIN)
    {
		...
		else
		{
			...
			else 
			{
				...
				ShowPlayerDialog(playerid, DIALOG_LOGIN, DIALOG_STYLE_PASSWORD, "Login to Expensive", lstring, "Login", "Quit");
			}
		}
        return 1;
    }
	if(dialogid == DIALOG_REGISTER)
    {
		...
		if (strlen(inputtext) <= 5) return ShowPlayerDialog(playerid, DIALOG_REGISTER, DIALOG_STYLE_PASSWORD, "Registration Expensive", "Kata sandi minimal 5 Karakter!\nMohon isi Password dibawah ini:", "Register", "Tolak");
		
		if(!IsValidPassword(inputtext))
		{
			Error(playerid, "Sandi valid : A-Z, a-z, 0-9, _, [ ], ( )");
			ShowPlayerDialog(playerid, DIALOG_REGISTER, DIALOG_STYLE_PASSWORD, "Registration Expensive", "Kata sandi yang anda gunakan mengandung karakter yang valid!\nMohon isi Password dibawah ini:", "Register", "Tolak");
			return 1;
		}
	...
	if(dialogid == DIALOG_SETTINGS)
	{
		if(response)
		{
			switch(listitem)
			{
				...
				case 2:
				{	
					ShowPlayerDialog(playerid, DIALOG_HBEMODE, DIALOG_STYLE_LIST, "HBE Mode", ""LG_E"Enable (1)\n"LG_E"Enable (2)\n"RED_E"Disable", "Set", "Close");
				}
				case 3:
				{
		...
		if(response)
		{
			switch(listitem)
			{
				...
				{					
					...
					PlayerTextDrawShow(playerid, FiveM6[playerid]);
					PlayerTextDrawShow(playerid, FiveM7[playerid]);
					PlayerTextDrawShow(playerid, FiveM8[playerid]);
					PlayerTextDrawShow(playerid, FiveM9[playerid]);
					PlayerTextDrawShow(playerid, FiveM10[playerid]);
					...
					PlayerTextDrawShow(playerid, FiveM15[playerid]);
					PlayerTextDrawShow(playerid, FiveM16[playerid]);
					PlayerTextDrawShow(playerid, FiveM17[playerid]);
					PlayerTextDrawShow(playerid, FiveM18[playerid]);
					TextDrawShowForPlayer(playerid, TextDate);
					TextDrawShowForPlayer(playerid, TextTime);
				}
				case 2:
				{
					...
					PlayerTextDrawHide(playerid, FiveM2[playerid]);
					PlayerTextDrawHide(playerid, FiveM3[playerid]);
					PlayerTextDrawHide(playerid, FiveM4[playerid]);
					PlayerTextDrawHide(playerid, FiveM5[playerid]);
					PlayerTextDrawHide(playerid, FiveM6[playerid]);
					PlayerTextDrawHide(playerid, FiveM7[playerid]);
					PlayerTextDrawHide(playerid, FiveM8[playerid]);
					PlayerTextDrawHide(playerid, FiveM9[playerid]);
					PlayerTextDrawHide(playerid, FiveM10[playerid]);
					PlayerTextDrawHide(playerid, FiveM11[playerid]);
					PlayerTextDrawHide(playerid, FiveM12[playerid]);
					PlayerTextDrawHide(playerid, FiveM13[playerid]);
					PlayerTextDrawHide(playerid, FiveM14[playerid]);
					PlayerTextDrawHide(playerid, FiveM15[playerid]);
					PlayerTextDrawHide(playerid, FiveM16[playerid]);
					PlayerTextDrawHide(playerid, FiveM17[playerid]);
					PlayerTextDrawHide(playerid, FiveM18[playerid]);
				}
			}
		}
	}
			...
			else if(bData[bizid][bType] == 3)
			{
				switch(listitem)
				{
					...
					case 1:
					{
						...
						ShowPlayerDialog(playerid, DIALOG_TOYBUY, DIALOG_STYLE_LIST, ""RED_E"Expensive RP: "WHITE_E"Player Toys", string, "Select", "Cancel");
					}
					case 2:
					{
						if(price == 0)
		...
		if(response) 
		{
			...
			foreach(new i : PVehicles)
			{
				if(carid == pvData[i][cVeh])
				{
					...
					format(pvData[i][cPlate], 32, "Expensive-%d", rand);
		...
		if(response)
		{
			switch(listitem)
			{
				...
				case 2: // change bone
				{
					...
					ShowPlayerDialog(playerid, DIALOG_TOYPOSISI, DIALOG_STYLE_LIST, ""RED_E"Expensive RP: "WHITE_E"Player Toys", finstring, "Select", "Cancel");
				}
				case 3:
				{
	...
	if(dialogid == DIALOG_JOB)
    {
		...
		switch(listitem)
		{
			...
			case 10:
			{
				...
				ShowPlayerDialog(playerid, DIALOG_UNUSED, DIALOG_STYLE_MSGBOX, ""RED_E"Sparepart Job", str, "Close", "");
			}
		}
	}			
	...
	if(dialogid == DIALOG_GPS_JOB)
	{
		if(response)
		{
			switch(listitem)
			{
				...
				case 9://
				{
					SetPlayerRaceCheckpoint(playerid,1, 826.62, -613.77, 16.33, 0.0, 0.0, 0.0, 3.5); //sparepart
		...
		if(response)
		{
			switch(listitem)
			{
				case 0:
				{
					...
					SetPlayerRaceCheckpoint(playerid, 1, 1686.25, -1326.29, 17.43, 0.0, 0.0, 0.0, 3);//bank
					Gps(playerid, "Active!");
				}
				case 1:
				{
				...
				{
					pData[playerid][pGpsActive] = 1;
					SetPlayerRaceCheckpoint(playerid, 1, 1830.26, -1422.45, 13.60, 0.0, 0.0, 0.0, 3);//asgh
					Gps(playerid, "Active!");
				}
				case 4:
				{
				...
				{
					pData[playerid][pGpsActive] = 1;
					SetPlayerRaceCheckpoint(playerid, 1, 1198.13, -889.93, 43.16, 0.0, 0.0, 0.0, 3);//burgershot
					Gps(playerid, "Active!");
				}
			}
		}
		...
		if(response)
		{
			switch(listitem)
			{
				...
				case 2: //colt45 9mm
				{
					if(pData[playerid][pActivityTime] > 5) return Error(playerid, "Anda masih memiliki activity progress!");
					if(pData[playerid][pPotato] < 2) return Error(playerid, "Kamu Membutuhkan 2 potato.");
					if(pData[playerid][pSnack] < 2) return Error(playerid, "Kamu MembutuhKan 2 Snack.");
		...
		if(response)
		{
			switch (listitem)
			{
				...
				case 3:
				{
					...
					ShowPlayerDialog(playerid, DIALOG_GUDANGPEDAGANG, DIALOG_STYLE_LIST, "PEDAGANG", "Cola\nChiken\nPizza\nBurger\nSprunk", "Pilih", "Batal");
				}
			}
		}
		return 1;
	...
	if(dialogid == DIALOG_BANKDEPOSIT)
	{
		...
		else
		{
			...
			ShowPlayerDialog(playerid, DIALOG_UNUSED, DIALOG_STYLE_MSGBOX, ""ORANGE_E"Expensive RP: "LB_E"Bank", lstr, "Close", "");
		}
	}
	...
	if(dialogid == DIALOG_VERIFYCODE)
	{
		if(response)
		{
			...
			if(strval(inputtext) == pData[playerid][pVerifyCode])
			{
				...
				ShowPlayerDialog(playerid, DIALOG_REGISTER, DIALOG_STYLE_PASSWORD, "Registration Expensive", lstring, "Register", "Quit");
				return 1;
			}
	...
	if(dialogid == DIALOG_SERVERMONEY_STORAGE)
	{
		...
		else 
		{
			...
			ShowPlayerDialog(playerid, DIALOG_SERVERMONEY, DIALOG_STYLE_MSGBOX, "Expensive City Money", lstr, "Manage", "Close");
		}
	}
	...
	if(dialogid == DIALOG_BSHOP)
	{
		if(response)
		{
			switch(listitem)
			{
				case 0:
				{
					if(pData[playerid][pRedMoney] < 5000) return Error(playerid, "Anda tidak memiliki banyak uang merah untuk membeli barang ini");
