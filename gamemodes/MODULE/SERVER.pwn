...
CreateServerPoint()
{
	...
	AyamPickup = CreateDynamicPickup(1239, 23, 921.7545,-1299.1313,14.0938, -1, -1, -1, 50.0);
	...
	AyamText = CreateDynamic3DTextLabel(strings, COLOR_GREY, 921.7545,-1299.1313,14.0938, 5.0); // product
	...
	ObatPickup = CreateDynamicPickup(1241, 23, 1339.00, 1579.14, 3010.90, -1, -1, -1, 50.0);
	...
	ObatText = CreateDynamic3DTextLabel(strings, COLOR_GREY, 1339.00, 1579.14, 3010.90, 5.0); // product
...
Server_Save()
{
	...
	CreateServerPoint();
    format(str, sizeof(str), "UPDATE server SET servermoney='%d', material='%d', materialprice='%d', lumberprice='%d', component='%d', componentprice='%d', metalprice='%d', ayamfill='%d', ayamfillprice='%d', gasoil='%d', gasoilprice='%d', coalprice='%d', product='%d', productprice='%d', medicineprice='%d', medkitprice='%d', food='%d', foodprice='%d', seedprice='%d', potatoprice='%d', wheatprice='%d', orangeprice='%d', marijuana='%d', marijuanaprice='%d', fishprice='%d', gstationprice='%d', obatmyr='%d', obatprice='%d' WHERE id=0",
	...
	Food, FoodPrice, SeedPrice, PotatoPrice, WheatPrice, AyamFill, AyamFillPrice, OrangePrice, Marijuana, MarijuanaPrice, FishPrice, GStationPrice, ObatMyr, ObatPrice);
